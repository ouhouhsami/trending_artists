...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.born'
        db.add_column(u'artists_artist', 'born',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.death'
        db.add_column(u'artists_artist', 'death',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Artist.born'
        db.delete_column(u'artists_artist', 'born')

        # Deleting field 'Artist.death'
        db.delete_column(u'artists_artist', 'death')
